...
useGsap(() => {
  const startPreload = async () => {
      ...
      loadingScreenMasterTimeline(refs , onComplete);
    };
    startPreload();
}, [onComplete]);
  ...
  return (
    <div className="fixed inset-0 z-50 font-barlow bg-[#00031f] flex items-end pb-12 justify-center overflow-hidden">
      <div className="text-center relative">
        <div ref={refs.rocketRef} className="size-46 mx-auto mb-4 transition-transform duration-300">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(180)].map((_, i) => (
          <div 
            key={i}
            ref={el => refs.starsRef.current[i] = el}
